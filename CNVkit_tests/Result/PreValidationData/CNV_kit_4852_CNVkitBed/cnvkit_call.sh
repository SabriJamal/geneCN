...
python $cnv_kit_path/cnvkit.py batch $mydirec/test_data/1709561-118-T.sort.bam --normal $mydirec/test_data/1709560-118-B.sort.bam \
	--targets $mydirec/ModifiedBeds/panel_PAED_CNVkitGen.bed \
	...
	--output-reference $mydirec/Result/CNV_kit_4852_CNVkitBed/118_reference.cnn --output-dir $mydirec/Result/CNV_kit_4852_CNVkitBed \
	--diagram --scatter
